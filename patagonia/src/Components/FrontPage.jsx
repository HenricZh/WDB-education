...
import { Box, Center, Button, Flex, Spacer, IconButton, Modal, ModalContent, ModalFooter, ModalOverlay, ModalHeader, ModalCloseButton, ModalBody } from '@chakra-ui/react'
...
const FrontPage = () => {
    ...
    return (
        <Box height="50%" align="center" bgImage={mountains} bgRepeat="no-repeat" bgSize="cover" bgPos="center">
            <Box color="white" fontWeight={700} hieght={90} bgColor="none">
                <Flex height={90} pt={10} justifyContent="center" alignItems="center">
                    <Center ml="5%" mt="1.5%" width="13%" fontSize="32px">
                        patagonia
                    </Center>
                    <Spacer/>
                    <Box ml="5%" px="5%" mt={4}>
            ...
            <Center paddingTop="15%" color="white" fontWeight={700} fontSize="3.8rem">
                Keep the Tongass Roadless
            </Center>
            <Center width="45%" color="white" fontSize="1.3rem">
            ...
            <Box w="100%" textAlign="center" mt={10}>
                {/*add colorScheme='white' to remove "hover" effect*/}
                <Button w="200px" h="50px" mx={5} color='white' rounded="xl" variant="outline"  fontWeight={700}>
